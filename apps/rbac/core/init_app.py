...
from apps.rbac.schemas.menu import MenuType
from apps.rbac.services.api_service import api_service
from apps.rbac.services.user_service import user_service
from apps.rbac.schemas.user import UserCreate
from apps.rbac.utils.logger import logger
...
async def init_db():
    command = Command(tortoise_config=settings.TORTOISE_ORM, app="rbac")
    try:
